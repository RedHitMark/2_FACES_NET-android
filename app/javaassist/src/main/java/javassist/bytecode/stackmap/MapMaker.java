...
public class MapMaker extends Tracer {
    ...
    public static void main1(String className) throws Exception {
        ...
        //javaassist.CtClass cc = cp.get(className);
        javaassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(className));
    ...
    public static void main2(String[] args) throws Exception {
        ClassPool cp = ClassPool.getDefault();
        //javaassist.CtClass cc = cp.get(args[1]);
        javaassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(args[1]));
        MethodInfo minfo;
