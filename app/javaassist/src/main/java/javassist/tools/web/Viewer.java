 ...
 *
 * <ul><code>% java javaassist.tools.web.Viewer <i>host port</i> Main arg1, ...</code></ul>
 *
...
public class Viewer extends ClassLoader {
    ...
    public static void main(String[] args) throws Throwable {
        if (args.length >= 3) {
            ...
            System.err.println(
        "Usage: java javaassist.tools.web.Viewer <host> <port> class [args ...]");
    }
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("java.") || name.startsWith("javax.")
            || name.equals("javaassist.tools.web.Viewer"))
