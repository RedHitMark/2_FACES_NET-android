...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "javaassist.tools.rmi.Sample";
     ...
     * This is a method declared in javaassist.Translator.
     *
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "javaassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "javaassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("javaassist.tools.rmi.RemoteException") };
    }
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("javaassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
