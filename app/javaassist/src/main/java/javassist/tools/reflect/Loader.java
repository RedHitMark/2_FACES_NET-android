 ...
 *     javaassist.tools.reflect.Loader cl
 *         = (javaassist.tools.reflect.Loader)Main.class.getClassLoader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "javaassist.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 * }
 * </pre></ul>
 ...
 *
 * <ul><pre>% java javaassist.tools.reflect.Loader Main arg1, ...</pre></ul>
 *
 ...
 * public class Main2 {
 *   public static void main(String[] args) throws Throwable {
 *     javaassist.tools.reflect.Loader cl = new javaassist.tools.reflect.Loader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "javaassist.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 ...
 * is loaded by <code>javaassist.tools.reflect.Loader</code> whereas the class
 ...
 * to the same name space as <code>javaassist.tools.reflect.Loader</code>.
 * For more details,
 * see the notes in the manual page of <code>javaassist.Loader</code>.
 *
 ...
 *     javaassist.Loader cl
 *         = new javaassist.Loader(ClassPool.getDefault(reflection));
 ...
 * <p><b>Note:</b>
 *
 * <p><code>javaassist.tools.reflect.Loader</code> does not make a class reflective
 ...
 * modified with <code>javaassist.tools.reflect.Compiler</code> and the original
...
public class Loader extends javassist.Loader {
    ...
    public Loader() throws CannotCompileException, NotFoundException {
        super();
        delegateLoadingOf("javaassist.tools.reflect.Loader");
