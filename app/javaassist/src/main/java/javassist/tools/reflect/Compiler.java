 ...
 * without <code>javaassist.tools.reflect.Loader</code>
...
public class Compiler {
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (entries[i].metaobject != null
                ...
                if (entries[i].metaobject == null)
                    metaobj = "javaassist.tools.reflect.Metaobject";
                else
                    metaobj = entries[i].metaobject;

                if (entries[i].classobject == null)
                    classobj = "javaassist.tools.reflect.ClassMetaobject";
                else
    ...
    private static void help(PrintStream out) {
        out.println("Usage: java javaassist.tools.reflect.Compiler");
