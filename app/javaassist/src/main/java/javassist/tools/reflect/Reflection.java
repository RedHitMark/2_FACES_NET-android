...
public class Reflection implements Translator {
    ...
    static final String metaobjectClassName = "javaassist.tools.reflect.Metaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        classPool = pool;
        final String msg
            = "javaassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c = classPool.get("javaassist.tools.reflect.Sample");
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtClass mlevel = classPool.get("javaassist.tools.reflect.Metalevel");
        ...
        CtField f;
        if (addMeta) {
            f = new CtField(classPool.get("javaassist.tools.reflect.Metaobject"),
        ...
        f = new CtField(classPool.get("javaassist.tools.reflect.ClassMetaobject"),
