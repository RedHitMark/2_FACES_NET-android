...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "javaassist.util.proxy.RuntimeSupport";
    ...
    private static Comparator<Map.Entry<String, ?>> sorter = new Comparator<Map.Entry<String, ?>>() {
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("javaassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
